...
public class CatalogNewsAdapter extends CommonItemAdapter<CatalogNewsFavoriteModel, CatalogNewsAdapter.ViewHolder> {

    public CatalogNewsAdapter(CommonActivity activity, Integer orgId, List<CatalogNewsFavoriteModel> items, CompositeDisposable disposable) {
    ...
    @Override
    protected void fillViewHolder(ViewHolder holder, CatalogNewsFavoriteModel item) {
