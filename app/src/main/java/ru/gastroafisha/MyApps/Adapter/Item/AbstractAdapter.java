...
public class AbstractAdapter extends CommonItemAdapter<CatalogAbstractFavoriteModel, AbstractAdapter.ViewHolder> {

    public AbstractAdapter(CommonActivity activity, Integer orgId, List<CatalogAbstractFavoriteModel> items, CompositeDisposable disposable) {
    ...
    @Override
    protected void fillViewHolder(ViewHolder holder, CatalogAbstractFavoriteModel item) {
        ...
        if (holder.photoUrl == null || !holder.photoUrl.equals(item.getItem().getPhoto().getUrl())) {
